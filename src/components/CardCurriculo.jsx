...
export default function CardCurriculo({ curriculoInputRef, handleCurriculoClick }) {
  ...
  const fetchCurriculoUrl = async () => {
    ...
    try {
      const response = await fetch(`10.0.132.210/usuarios/${userId}`, {
        method: "GET",
        credentials: "include",
        headers: {
  ...
  const handleFileUpload = async (e) => {
    ...
    try {
      const response = await fetch(`http://10.0.132.210/usuarios/${userId}/curriculo/upload`, {
        method: "POST",
        body: formData,
        headers: {
          "Authorization": `Bearer ${userToken}`
  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await fetch(`http://10.0.132.210/usuarios/${userId}/curriculo/delete`, {
        method: "DELETE",
        headers: {
          "Authorization": `Bearer ${userToken}`
        }
